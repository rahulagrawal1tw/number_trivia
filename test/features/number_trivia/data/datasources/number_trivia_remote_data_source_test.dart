...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    test('''should preform a GET request on a URL with 
    ...
    test(
      ...
      () async {
        ...
        // act
        final call = await dataSourceImpl.getConcreteNumberTrivia;
        // assert
  ...
  group('getRandomNumberTrivia', () {
    ...
    test(
      'should throw a ServerException when the response code is 404 or other',
        ...
        setUpMockHttpClientFailure404();
        // act
        final call = await dataSourceImpl.getRandomNumberTrivia;
        // assert
